...
// Copy constructor
ClapTrap::ClapTrap(const ClapTrap &obj) { ClapTrap::operator=(obj); }
...
void	ClapTrap::setHealth(int value) { h_p = value; }

int	ClapTrap::getEnergy() const { return e_p; }

void	ClapTrap::setEnergy(int sign, int value)
{
	if (sign == '-')
		e_p -= value;
	else if (sign == '+')
		...
		std::cout << "~~Invalid sign in setEnergy() for value = " << value << "\n";
}

int	ClapTrap::getAttack() const { return a_d; }

void	ClapTrap::setAttack(int value) { a_d = value; }
